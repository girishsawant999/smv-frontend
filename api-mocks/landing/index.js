  ...
  const response = {
    ...
    data: {
      ...
      CountryVisaDetailFast: [
        ...
        // {
        //   imageLink: '/assets/landing/Bitmap-20.png',
        //   country: 'Portugal',
        //   time: '5-6 working days'
        // },
        // {
        //   imageLink: '/assets/landing/Bitmap-21.png',
        //   country: 'Russia',
        //   time: '7-8 working days'
        // },
        // {
        //   imageLink: '/assets/landing/Bitmap-22.png',
        //   country: 'Srilanka',
        //   time: '5-6 working days'
        // }
      ],
      BlogArray: [
        {
          imageLink: '/assets/landing/kristian-egelund-uaQvRXa8izg-unsplash-2.png',
          statement: 'How to extend your visa if you are stranded due to COVID-19',
          date: 'Jan 1,2021'
        },
        {
          imageLink: '/assets/landing/kristian-egelund-uaQvRXa8izg-unsplash-3.png',
          statement: 'How to extend your visa if you are stranded due to COVID-19',
          date: 'Jan 1,2021'
        }
      ],
