		...
		data: {
			SuggestedCountryVisaDetail: [
				...
				},
				{
					imageLink: {
						imageLink_1x:
							'landing/country_russia_images/bitmap-copy-3.png',
						imageLink_2x:
							'landing/country_russia_images/bitmap-copy-3@2x.png',
						imageLink_3x:
							'landing/country_russia_images/bitmap-copy-3@3x.png'
					},
					country: 'Russia',
				...
				},
				{
					imageLink: {
						imageLink_1x:
							'landing/country_srilanka_images/bitmap-copy.png',
						imageLink_2x:
							'landing/country_srilanka_images/bitmap-copy@2x.png',
						imageLink_3x:
							'landing/country_srilanka_images/bitmap-copy@3x.png'
					},
					country: 'Srilanka',
					time: '5-6 working days'
				},
			...
			BlogArray: [
				{
					...
					statement:
						'How to extend your visa if you are stranded due to COVID-19',
					date: 'Jan 1,2021'
				},
				{
					imageLink: {
