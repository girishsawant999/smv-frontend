...
import DocumentsSection, {documentStatusType} from "components/common/DocumentsSection";
    ...
    return (
        <div className="flex flex-col md:max-w-sm md:mx-auto shadow-lg relative">
            ...
            <section className="mx-5 my-5">
                <CountryInfoCard heading={`${tripObject.country},${tripObject.city}`} subHeading={tripObject.visaType} date={tripObject.dates}/>
            </section>
            
            <section className="mx-5 my-5">
                <DocumentsSection status={tripObject.status} documents={tripObject.documents}/>
            </section>
