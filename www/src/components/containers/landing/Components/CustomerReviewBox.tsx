...
function avatarImage(gender:string){
    if(gender == 'male'){
        return(
            <div className="w-20">
                <Img
                    srcSet={['landing/avatar_male_image/image-removebg-3.png 1x',
        ...
        return(
            <div className="w-16">
                <Img
                    srcSet={['landing/avatar_female_image/image-removebg-4.png 1x',
       ...
       <div key={index} className="flex mt-10 w-2/3">
           <div className="relative flex">
               <div className="bg-white rounded-20px p-5">
                   <Typography type="content" size="12" weight="semi-bold" variant="h3">{item.comment}</Typography>
                   <Typography type="heading" size="10" weight="semi-bold" variant="h4" className="mt-3">{item.name}</Typography>
                   <Typography type="content" size="12" weight="regular" variant="p" >{item.country}</Typography>
               </div>
