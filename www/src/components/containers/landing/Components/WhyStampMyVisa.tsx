    ...
    <div className="relative">
      <div className="relative bg-#3CC39A bg-opacity-20 rounded-3xl flex-col pt-6 mt-5 xmd:h-120">
        <div className="flex text-2xl italic font-sequel text-#3CC39A justify-center">
          <marquee width="100%" direction="left">
            BOOKINGS FOR VISA <span className="text-center text-2xl">&#8226;</span>{' '}
            BOOKINGS FOR VISA
        ...
        <Typography
          ...
          tempor incididunt ut labore et sed do F.A.S.T
        </Typography>
        <div className="flex justify-end mt-10">
          <div className="">
            <Img
              srcSet={[
                'landing/plane_image/bitmap_5.png 1x',
        ...
        <div className="absolute right-0 bottom-14 xmd:bottom-48">
          <div className="w-11 origin-right">
            <Img
              srcSet={[
                'landing/right_cloud_image/bitmap_6.png 1x',
      ...
      <div className="absolute top-56 -left-16 xsm:-left-5 xmd:top-80">
        <div className="">
          <Img
            srcSet={[
              'landing/left_cloud_image/bitmap_7.png 1x',
