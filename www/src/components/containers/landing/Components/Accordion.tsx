...
function Accordion({ question, answer }: IAccordionProp) {
  ...
  return (
    <div className="border-b-2">
      <div
        className="w-full relative border-none focus:outline-none flex items-center justify-between"
        ...
        <Typography
          ...
          size="16"
          variant="p"
          className="justify-between text-left flex py-4 mr-10 w-4/5">
          {question}
        </Typography>
      ...
      <div
        className={
          !selected ? 'hidden transition-all max-h-0 duration-700 ' : 'pb-4 mr-10'
        }>
