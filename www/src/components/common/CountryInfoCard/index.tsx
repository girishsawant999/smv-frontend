...
const CountryInfoCard = ({heading, subHeading, date, content, status}:ICoutryInfoProps) => {
    return(
        <>
            <div className="flex flex-wrap">
                ...
                <div className="w-4/12 text-right">
                    { status && (
                        <Typography size="24" weight="extra-bold" variant="p" className="mb-1">
                            {status}
                        </Typography>
                    )}
                </div>
                ...
                <div className="w-5/12 text-right">
                    { date && (
                        <Typography size="14" type="content" weight="regular" variant="h3" className="mb-2.5">
                            {date}
                        </Typography>
                    )}
                </div>
